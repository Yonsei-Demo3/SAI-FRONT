...
export default function QuestionFormScreen() {
  ...
  const { contentId, imageUrl } = location.state || {};
            ...
            {selectedContent ? (
              <>
                ...
                <div className="w-full flex flex-col justify-center items-center">
                  <img src={selectedContent.imageUrl} alt="Selected Content"  className="max-h-[12rem] w-auto object-contain rounded-[0.5rem]" />
                </div>
                
                <button
                    type="button"
                    onClick={() => setSelectedContent(null)}
                    className="bg-[#3B3D40] rounded-full w-[1.5rem] h-[1.5rem] border-none flex items-center justify-center absolute right-[1rem] bottom-[1rem]"
                    >
                ...
                <>
                  ...
                  >
                    <button onClick={() => window.location.href = "/content/search/result"}>
