...
export default function QuestionTopBar(){
  return (
    <div className="sticky top-0 z-20 bg-white">
      <div className="mx-auto max-w-[760px] flex items-center justify-between h-12 px-3">
        <button aria-label="뒤로가기" className="p-2 bg-white ">
        ...
        <div className="flex items-center gap-1">
          <button aria-label="메뉴" className="p-2 rounded-full hover:bg-neutral-100">
